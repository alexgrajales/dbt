select
       ...
       substr(trim("Fecha de recuperación"), 0, 10) as fecha_reporte,
       substr(trim("Fecha de notificación"), 0, 10) as fecha_notificacion,
       substr(trim("Fecha de diagnóstico"), 0, 10) as fecha_diagnóstico,
       substr(trim("Fecha de inicio de síntomas"), 0, 10) as fecha_síntomas,
       substr(trim("Fecha de recuperación"), 0, 10) as fecha_recuperación,
       substr(trim("Fecha de muerte"), 0, 10) as fecha_muerte,
